...
# def fm_scorer(action_emb, item_emb, item_dim, dropout_rate ):
#     '''
#     score = FM(item_emb)
#     - Linear component:
#         - score1 = item_emb * weight + bias
#     - 2nd order component:
#         - score2 = item_emb
#     - score = 0.5 * score1 + 0.5 * score2
...
#     # final score
#     output = deep_score * 0.5 + wide_score * 0.5
#     return outputHyper-Actor-Critic-for-Recommendation/model/__init__.py
