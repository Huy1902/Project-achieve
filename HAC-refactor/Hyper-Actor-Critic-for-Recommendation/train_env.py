...
#     mode_group.add_argument("--eval", action="store_true", help="Run eval")
    ...
    try:
        ...
        while epo < args.epoch:
            ...
            plot_multiple_line(['Model'], [info], x_name='Train phase', y_name='Loss Value')
            ...
            # Plot ROC curve
            fpr, tpr, _ = roc_curve(np.concatenate(valid_true).ravel(), np.concatenate(valid_probs).ravel())
